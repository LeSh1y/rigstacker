...
COLUMNS = {
    'recommended_new_price': 'DECIMAL(10,2) NULL',
    'recommended_new_source': 'VARCHAR(50) NULL',
    'recommended_new_offer_id': 'INT NULL',
    'recommended_new_external_id': 'VARCHAR(255) NULL',
